...
<head>
  <meta charset="UTF-8" />
  <title>قسم الإعلام الالي - الطور الثانوي</title>
...
function showModules($year){
    $modules = [
        ...
        'السنة الخامسة' => ['مقياس 1','مقياس 2','مقياس 3','مقياس 4','مقياس 5','مقياس 6','مقياس 7','مقياس 8'],
    ];
...
<div class="modules-wrapper">
    <div class="modules-menu">
        ...
        <ul>
            ...
            <li onclick="showYear(5)"><a href="#">السنة الخامسة</a></li>
        </ul>
    </div>
    ...
    <div class="modules-content" id="year5">
        <?php showModules('السنة الخامسة'); ?>
    </div>
